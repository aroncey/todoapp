This project was created as a react example app.
by Arthur Roncey

Intended Future New Feature/Styling modifications:
- Add update functionality to todo items
- add modal for input of edited Task Names
- add tooltips in lower right corner of screen (any size)
  - tooltip would display when new todo item is added.
    - purpose: tell user that a item was added to its list, even if the user cant see it a it ranks items from first added to last added.

- Change color scheme

- add redux

- add OAuth, Google Chrome. 
